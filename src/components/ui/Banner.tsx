...
const variantStyles: Record<BannerVariant, {
  ...
  amber: {
    container: "bg-gradient-to-r from-amber-50 from-amber-900/20 to-orange-900/20 border border-amber-800",
    icon: "bg-amber-900/50 text-amber-400",
    title: "text-amber-100",
    text: "text-amber-300",
    button: "bg-amber-700 text-white hover:bg-amber-800",
    dismiss: "text-amber-400 text-amber-500 hover:text-amber-300",
  },
  blue: {
    container: "bg-blue-900/20 border border-blue-800/50",
    icon: "bg-blue-900/50 text-blue-400",
    title: "text-blue-400",
    text: "text-gray-300",
    button: "bg-blue-700 text-white hover:bg-blue-800",
    dismiss: "text-blue-400 text-blue-500 hover:text-blue-300",
  },
  gray: {
    container: "bg-gray-900/40 border border-gray-700",
    icon: "bg-gray-800 text-gray-400",
    title: "text-gray-100",
    text: "text-gray-300",
    button: "bg-gray-600 text-white hover:bg-gray-700",
    dismiss: "text-gray-400 text-gray-500 hover:text-gray-300",
  },
};

    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4 px-2">
        ...
        <Link
          ...
          className="flex items-center gap-1 text-sm font-medium text-gold-500 hover:text-yellow-400 transition-colors whitespace-nowrap"
        >
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
          ...
          >
            <div className="aspect-[2/3] rounded-lg border-2 border-dashed border-gray-600 hover:border-yellow-500/60 bg-gray-900/40 hover:bg-gray-800/60 transition-all flex flex-col items-center justify-center gap-3 cursor-pointer group">
              <ChevronRight className="w-8 h-8 text-gray-500 group-hover:text-gold-500 transition-colors" />
              <span className="text-sm font-medium text-gray-400 group-hover:text-gold-500 transition-colors">
                See All
              </span>

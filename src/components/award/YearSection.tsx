	...
	return (
		<section className="w-full max-w-screen-xl px-6 py-0 mx-auto my-0 font-sans">
			<div className="relative flex flex-col gap-3 md:flex-row md:gap-8">
				...
				{/* Content block */}
				<div className="flex flex-col md:flex-row w-full rounded-xl shadow-md border border-gray-600/50 p-3 md:p-6 mb-8 md:mb-24 gap-4 md:gap-12 transition-all duration-300 hover:shadow-lg dark-glass">
					{/* Winner */}

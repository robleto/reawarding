	...
	return (
		<section className="w-full max-w-screen-xl px-6 py-0 mx-auto my-0 font-sans">
			<div className="relative flex flex-col gap-3 md:flex-row md:gap-8">
				...
				<h2 className="hidden md:block md:absolute top-0 md:top-[125px] left-0 text-3xl font-bold text-[#A0A0A0] text-[#9CA3AF] mt-2 md:rotate-[-90deg] origin-left font-['Unbounded'] tracking-widest">
					{year}
				</h2>
				<div className="top-0 bottom-0 flex-col items-center hidden md:absolute md:flex left-4">
					<div className="w-5 h-5 mt-2 rounded-full bg-[#A0A0A0] bg-[#9CA3AF] border-2 border-[#F4F4F4] border-gray-800" />
					<div className="w-[2px] flex-1 bg-[#bebebe] bg-gray-600" />
				</div>
				...
				{/* Content block */}
				<div className="flex flex-col md:flex-row w-full rounded-xl shadow-md border border-[#d6d6d3] border-gray-600/50 p-3 md:p-6 mb-8 md:mb-24 gap-4 md:gap-12 transition-all duration-300 hover:shadow-lg dark-glass">
					{/* Winner */}
					<div className="w-full md:w-1/3 max-w-[300px] mx-auto">
						<div className="inline-flex items-center justify-center gap-2 mb-2 md:mb-4">
							...
							<h3 className="text-xl md:text-2xl font-bold text-[#cb8601] text-gold-400 font-unbounded">
								Winner
							</h3>
						</div>
						{winner ? (
					...
					{/* Divider */}
					<div className="hidden md:block w-px bg-[#d6d6d3] bg-gray-600/50" />
					...
					{/* Nominees */}
						<div className="w-full md:w-2/3">
							...
							<h3 className="text-xl md:text-2xl font-bold text-[#7e7e7e] text-gray-200">

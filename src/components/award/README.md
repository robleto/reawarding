...
Retrieves existing award nominations for a user, year, and category.

**Query Parameters**:

- `year`: The year to fetch nominations for (required)
- `category`: One of `best-picture` | `best-animated` | `best-comedy` | `best-drama` (optional, defaults to `best-picture`)
...
Saves award nominations for a user, year, and category.
...
{
  "year": "2023",
  "category": "best-picture", // optional, defaults to best-picture

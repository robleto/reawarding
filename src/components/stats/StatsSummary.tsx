              ...
              <div className="flex items-center justify-between sm:justify-start gap-3 sm:gap-4 md:gap-5 lg:gap-6 flex-1">
                {items.map((item) => (
                  <div key={item.key} className="flex items-center gap-1.5 sm:gap-2">
                    <div className="text-gold-500 bg-gold-500/10 p-1 sm:p-1.5 rounded flex-shrink-0">
                      {item.icon}
                    </div>
              ...
              items.map((item) => {
                ...
                const Card = (
                  ...
                  >
                    ...
                    <div className="shrink-0 text-gold-500 bg-gold-500/10 p-1.5 sm:p-2 rounded-lg">
                      {item.icon}
                    </div>
                  </div>
                );

...
export default function UnifiedBanner({ onSignupClick, onLoginClick, excludeBannerTypes = [] }: UnifiedBannerProps) {
  ...
  const renderBannerContent = () => {
    switch (activeBanner) {
      case 'welcome':
        return (
          <div className="bg-gradient-to-r from-blue-50 from-blue-900/20 to-purple-900/20 border border-blue-800 rounded-lg p-6 mb-8">
            ...
            <button
              ...
              className="absolute top-4 right-4 p-1 text-gray-400 text-gray-500 hover:text-gray-300"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
      ...
      case 'returning':
        return (
          <div className="bg-gradient-to-r from-amber-50 from-amber-900/20 to-orange-900/20 border border-amber-800 rounded-lg p-4 mb-6 shadow-sm">
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button
                      onClick={onSignupClick}
                      className="inline-flex items-center px-3 py-2 bg-amber-700 text-white text-sm font-medium rounded-lg hover:bg-amber-800 transition-colors"
                    >
                    ...
                    {onLoginClick && (
                      <button
                        ...
                        className="inline-flex items-center px-3 py-2 border border-amber-600 text-amber-300 text-sm font-medium rounded-lg hover:bg-amber-900/30 transition-colors"
                      >
              ...
              <div className="flex flex-col gap-1">
                <button
                  onClick={dismissBanner}
                  className="p-1 text-amber-400 text-amber-500 hover:text-amber-300"
      ...
      case 'save-prompt':
        return (
          <div className="bg-gradient-to-r from-blue-50 from-blue-900/20 to-indigo-900/20 border border-blue-800 rounded-lg p-4 mb-6 shadow-sm">
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 mt-1">
              ...
              <button
                onClick={dismissBanner}
                className="p-1 text-blue-400 text-blue-500 hover:text-blue-300"
              >
                <X className="w-4 h-4" />
              </button>
            </div>

...
import { Trophy, Star, ArrowRight, Calendar, Award } from "lucide-react";
      ...
      <div className="text-center pt-16  pb-0 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
            Discover and rate the best movies of the year. Create your own personal awards ceremony 
            and find the films that deserve to win Best Picture.
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center opacity-75">
            <div className="p-4">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-400">Movies Available</div>
            </div>
            <div className="p-4">
              <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mb-1">95</div>
              <div className="text-xs text-gray-600 dark:text-gray-400">Years Covered</div>
            </div>
            <div className="p-4">
            ...
            <div className="p-4">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-400">Personal Awards</div>
            </div>
          </div>
        </div>
      </div>

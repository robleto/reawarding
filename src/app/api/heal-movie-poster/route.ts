 ...
 *
 * Lightweight on-demand poster heal. Called when MovieDetailModal opens on a
 * movie with a missing poster_url. Requires any authenticated user (not admin-only).
 *
 * Body: { dbId: number; tmdbId: number }

  ...
  if (!user) {
    return (
      <main className="max-w-screen-xl px-6 py-10 mx-auto">
        <h1 className="text-3xl font-unbounded text-gray-100">Friends</h1>
  ...
  return (
    <main className="max-w-screen-xl px-6 py-10 mx-auto">
      <div className="flex items-baseline justify-between gap-4">
        <h1 className="text-3xl font-unbounded text-gray-100">Friends</h1>
        <Link href="/activity" className="text-sm text-gold-300 hover:underline">View activity</Link>
      </div>
      ...
      <div className="mt-6 p-5 rounded-xl bg-gray-900/60 border border-gold-500/20">
        ...
        <div className="mt-3 flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="flex-1 px-3 py-2 rounded-lg bg-gray-950/40 border border-gold-500/20 text-gray-100 placeholder:text-gray-500"
          />
          <button
            onClick={handleSearch}
            disabled={searching || loading}
            className="px-4 py-2 rounded-lg bg-gold-500/20 border border-gold-500/30 text-gold-200 hover:bg-gold-500/30 disabled:opacity-50"
          >
        ...
        {searchResult && (
          <div className="mt-4 flex items-center justify-between gap-3 p-3 rounded-lg bg-gray-950/30 border border-gold-500/10">
            ...
            <button
              ...
              disabled={loading}
              className="px-3 py-1.5 rounded-md bg-gold-500/20 border border-gold-500/30 text-gold-200 hover:bg-gold-500/30 disabled:opacity-50"
            >
              Send request
            </button>
          </div>
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <section className="p-5 rounded-xl bg-gray-900/60 border border-gold-500/20">
          ...
          <div className="mt-3 space-y-3">
            {incoming.length === 0 ? (
              ...
              incoming.map((f) => (
                <div key={f.id} className="flex items-center justify-between gap-3 p-3 rounded-lg bg-gray-950/30 border border-gold-500/10">
                  <div className="min-w-0">
                    <div className="text-gray-100 font-medium truncate">

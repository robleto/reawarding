  ...
  return (
    <main className="max-w-screen-xl px-6 py-10 mx-auto">
      <div className="flex items-baseline justify-between gap-4">
        <h1 className="text-3xl font-unbounded text-gray-100">Leaderboard</h1>
        <Link href="/films" className="text-sm text-gold-300 hover:underline">Browse films</Link>
      </div>
      ...
      <div className="mt-6 overflow-hidden rounded-xl border border-gold-500/20 bg-gray-900/60">
        <div className="grid grid-cols-12 px-4 py-3 text-xs uppercase tracking-wide text-gray-400 border-b border-gold-500/10">
        ...
        {rows.length === 0 ? (
          ...
          rows.map((r, i) => {
            ...
            return (
              <div
                key={r.user_id}
                className="grid grid-cols-12 px-4 py-3 text-sm text-gray-200 border-b border-gold-500/5 last:border-b-0"
              >
                ...
                <div className="col-span-2 text-right font-semibold text-gold-300">{r.score}</div>

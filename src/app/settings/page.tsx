        ...
        <div className="space-y-4">
          ...
          <div className="pt-2">
            <button
              ...
              disabled={loading}
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-200 border border-gray-600 rounded-lg hover:bg-gray-700 disabled:opacity-50 transition-colors"
            >

...
export default function AwardsPage() {
	...
	useEffect(() => {
		// Prevent running category/year formatting until after hydration & data load
		if (!hasMounted || movies.length === 0) {
			// Clear any stale data that might persist from a previous category
			setFormattedYears([]);
			return;
		}

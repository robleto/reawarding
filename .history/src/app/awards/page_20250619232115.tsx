...
import type { Database } from "@/types/database"; // if you're using Supabase types
...
export default async function AwardsPage() {
	...
	const { data: movies, error } = await supabase
		.from("movies")
		.select("id, title, release_year, thumb_url, rankings(ranking)")
	...
	const formattedYears: YearData[] = Object.entries(groupedByYear).map(
		([year, movies]) => {

...
import type { Movie as BaseMovie } from "@/types/types"; // Adjust the import path as needed

interface Movie extends BaseMovie {
	ranking: number;
	release_year?: number; // Ensure release_year is included if used
	rankings?: { ranking: number }[]; // Add rankings if used in logic
}

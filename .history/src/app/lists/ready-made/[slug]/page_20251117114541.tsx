        ...
        <div className="flex items-center gap-2">
          ...
          {count < 10 && (
            <form action={saveList}>
              ...
              <button
                type="submit"
                className="px-3 py-2 rounded border border-gray-700 text-yellow-300 hover:bg-gray-800 flex items-center gap-2"
                title="Locked until 10 seen — override to publish now"
              >

    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-gray-400">Auto-generated from your seen films • Director: {director}</p>
        </div>
          ...
          {count >= 10 ? (
            ...
            <div className="flex flex-col items-end">
              <button
                type="button"
                disabled
                className="px-4 py-2 rounded bg-gray-800 text-gray-400 border border-gray-700 cursor-not-allowed flex items-center gap-2"
                title="Locked until 10 seen"
              >
              ...
              <form action={saveList}>
                ...
                <input type="hidden" name="movie_ids" value={ids} />
                <input type="hidden" name="publish" value="1" />
                <button type="submit" className="mt-1 text-xs text-yellow-300 hover:underline" title="Publish anyway">
                  Publish anyway
                </button>
              </form>
            </div>

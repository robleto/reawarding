      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <form action={saveList}>
            ...
            <button className="px-4 py-2 text-black bg-yellow-500 rounded hover:bg-yellow-400" type="submit">Save as List</button>
          </form>
          {count < 10 && (
            <details className="relative">
              <summary className="list-none px-3 py-2 rounded bg-gray-800 text-gray-200 cursor-pointer hover:bg-gray-700 flex items-center gap-1">
                <svg className="w-4 h-4 text-yellow-300" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a5 5 0 00-5 5v3H6a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-8a2 2 0 00-2-2h-1V7a5 5 0 00-5-5zm-3 8V7a3 3 0 016 0v3H9z"/></svg>
                More
              </summary>
              <div className="absolute right-0 z-20 mt-2 w-56 rounded-md border border-gray-700 bg-gray-900 shadow-lg p-2">
                <div className="px-2 py-1 text-xs text-gray-400">Locked under 10 — override:</div>
                <form action={saveList}>
                  <input type="hidden" name="director" value={director} />
                  <input type="hidden" name="count" value={count} />
                  <input type="hidden" name="movie_ids" value={ids} />
                  <input type="hidden" name="publish" value="1" />
                  <button type="submit" className="w-full text-left px-3 py-2 rounded hover:bg-gray-800 text-yellow-300 flex items-center gap-2">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M5 3a2 2 0 00-2 2v6h2V5h10V3H5zm14 6h-4v2h4v8H5v-4H3v4a2 2 0 002 2h14a2 2 0 002-2v-8a2 2 0 00-2-2z"/></svg>
                    Save & Publish anyway
                  </button>
                </form>
              </div>

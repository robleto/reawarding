...
function GuestModeSection() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-unbounded font-semibold">Ready‑Made Lists</h2>
        <p className="text-gray-400 mt-1">You’re in guest mode — we’ll build suggestions from your local rankings. Sign in to save.</p>
      </div>
      {/* Client-side guest suggestions */}

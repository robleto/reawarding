...
function SuggestionCard({ suggestion }: { suggestion: DirectorSuggestion }) {
  ...
  return (
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg pt-12 pb-5 px-5 overflow-visible">
      {posterUrls.length > 0 && (
        <div className="absolute -top-6 left-1/2 -translate-x-1/2 h-28 w-[200px] flex items-center justify-center pointer-events-none select-none">

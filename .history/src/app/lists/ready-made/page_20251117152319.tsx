      ...
      {!user ? (
        ...
        <>
          ...
          {(activeTab === 'all' || activeTab === 'genres') && genreSuggestions.length > 0 && (
            <div className="mt-10">
              <h2 className="text-xl font-semibold mb-1">Genre Ready‑Made Lists</h2>
              <p className="text-sm text-gray-400 mb-3">Unlocks at 10 seen. Large genres show 9–10 only.</p>
          ...
          {(activeTab === 'all' || activeTab === 'decades') && decadeSuggestions.length > 0 && (
            <div className="mt-10">
              <h2 className="text-xl font-semibold mb-1">Decade Ready‑Made Lists</h2>
              <p className="text-sm text-gray-400 mb-3">Unlocks at 12 seen. Large decades show 9–10 only.</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          ...
          {(activeTab === 'all' || activeTab === 'genres') && genreAlmost.length > 0 && (
            <div className="bg-gray-900/60 border border-yellow-500/20 rounded-lg p-5 mt-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-gray-800 text-yellow-400" title="Locked until 10 seen" aria-label="Locked until 10 seen">
              ...
              <p className="text-sm text-gray-400 mb-4">Genres you are close to unlocking.</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {genreAlmost.map((g) => (
                  <div key={g.genre} className="bg-gray-800/50 rounded-md p-3">
                    <div className="text-white font-medium truncate" title={g.genre}>{g.genre}</div>
                    <div className="mt-2 flex items-center justify-between gap-3">
                      ...
                      <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-gray-700 text-gray-300" title="Locked until 10 seen">
          ...
          {(activeTab === 'all' || activeTab === 'decades') && decadeAlmost.length > 0 && (
            <div className="bg-gray-900/60 border border-yellow-500/20 rounded-lg p-5 mt-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-gray-800 text-yellow-400" title="Locked until 12 seen" aria-label="Locked until 12 seen">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a5 5 0 00-5 5v3H6a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-8a2 2 0 00-2-2h-1V7a5 5 0 00-5-5zm-3 8V7a3 3 0 016 0v3H9z"/></svg>
                </span>
              </div>
              <p className="text-sm text-gray-400 mb-4">Decades you are close to unlocking (needs 12 seen).</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {decadeAlmost.map((d) => (
                  <div key={d.decade} className="bg-gray-800/50 rounded-md p-3">
                    <div className="text-white font-medium truncate" title={d.decade}>{d.decade}</div>
                    <div className="mt-2 flex items-center justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="h-2 bg-gray-700 rounded">
                      ...
                      <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-gray-700 text-gray-300" title="Locked until 12 seen">
                        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a5 5 0 00-5 5v3H6a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-8a2 2 0 00-2-2h-1V7a5 5 0 00-5-5zm-3 8V7a3 3 0 016 0v3H9z"/></svg>
                      </span>
                    </div>
                  </div>
          ...
          {(activeTab === 'all' || activeTab === 'actors') && actorSuggestions.length > 0 && (
            <div className="mt-10">
              <h2 className="text-xl font-semibold mb-3">Actor Ready‑Made Lists</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          ...
          {(activeTab === 'all' || activeTab === 'directors') && almost.length > 0 && (
            <div className="bg-gray-900/60 border border-yellow-500/20 rounded-lg p-5 mt-6">
              ...
              <p className="text-sm text-gray-400 mb-4">Hit 10 seen films to unlock a Ready‑Made list. You can preview details with View.</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {almost.map((a) => (
                  <div key={a.director} className="bg-gray-800/50 rounded-md p-3">
                    <Link href={`/lists/ready-made/${slugifyTitle(a.director)}`} className="text-white font-medium hover:text-yellow-200 leading-snug">
                      {a.director}
                    </Link>
                    <div className="mt-2 flex items-center justify-between gap-3">
                      <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-gray-700 text-gray-300" title="Locked until 10 seen" aria-label="Locked until 10 seen">
                          <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a5 5 0 00-5 5v3H6a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-8a2 2 0 00-2-2h-1V7a5 5 0 00-5-5zm-3 8V7a3 3 0 016 0v3H9z"/></svg>
                        </span>
          ...
          {(activeTab === 'all' || activeTab === 'actors') && actorAlmost.length > 0 && (
            <div className="bg-gray-900/60 border border-yellow-500/20 rounded-lg p-5 mt-6">
              ...
              <p className="text-sm text-gray-400 mb-4">Actors you are close to unlocking.</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {actorAlmost.map((a) => (
                  <div key={a.actor} className="bg-gray-800/50 rounded-md p-3">
                    <div className="text-white font-medium truncate" title={a.actor}>{a.actor}</div>
                    <div className="mt-2 flex items-center justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="h-2 bg-gray-700 rounded">
                          <div className="h-2 bg-yellow-500 rounded" style={{ width: `${Math.min(100, (a.seen_count/10)*100)}%` }} />
...
function SuggestionCard({ suggestion }: { suggestion: DirectorSuggestion }) {
  ...
  return (
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg pt-[88px] pb-5 px-5 overflow-visible min-h-[320px]">
      {posterUrls.length > 0 && (
        <div className="absolute -top-2 left-1/2 -translate-x-1/2 h-24 w-[180px] flex items-center justify-center pointer-events-none select-none z-0">
      ...
      <div className="relative z-10 mt-[10px] flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <Link href={href} className="block">
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold truncate hover:text-yellow-200 transition-colors" title={suggestion.director}>{suggestion.director}</h3>
              <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-800 text-xs text-gray-200" title="You've seen">
                {suggestion.seen_count}
              </span>
            </div>
          </Link>
          <p className="text-sm text-gray-400">Auto-generated from your seen films • Director</p>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="mt-3 flex items-center gap-3">
        <Link href={href} className="text-sm text-yellow-300 hover:underline whitespace-nowrap">View</Link>
  ...
  return (
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg pt-[88px] pb-5 px-5 overflow-visible min-h-[320px]">
      ...
      <div className="relative z-10 mt-[10px] flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold truncate hover:text-yellow-200 transition-colors" title={suggestion.actor}>{suggestion.actor}</h3>
            <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-800 text-xs text-gray-200" title="You've seen">
              {suggestion.seen_count}
            </span>
          </div>
          <p className="text-sm text-gray-400">Auto-generated from your seen films • Actor</p>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="mt-3 flex items-center gap-3">
        <Link href={`/lists/ready-made/${slugifyTitle(suggestion.actor)}`} className="text-sm text-yellow-300 hover:underline whitespace-nowrap">View</Link>
    ...
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg pt-[88px] pb-5 px-5 overflow-visible min-h-[320px]">
      ...
      <div className="relative z-10 mt-[10px] flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <Link href={href} className="block">
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold truncate hover:text-yellow-200 transition-colors" title={suggestion.genre}>{suggestion.genre}</h3>
              <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-800 text-xs text-gray-200" title="You've seen">
                {filteredCount}{totalSeen > 100 ? '∗' : ''}
              </span>
            </div>
          </Link>
    ...
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg pt-[88px] pb-5 px-5 overflow-visible min-h-[320px]">
      ...
      <div className="relative z-10 mt-[10px] flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <Link href={href} className="block">
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold truncate hover:text-yellow-200 transition-colors" title={suggestion.decade}>{suggestion.decade}</h3>
              <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-800 text-xs text-gray-200" title="You've seen">
                {filteredCount}{totalSeen > 100 ? '∗' : ''}
              </span>
            </div>

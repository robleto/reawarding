...
function SuggestionCard({ suggestion }: { suggestion: DirectorSuggestion }) {
  ...
  return (
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg h-[280px] flex flex-col overflow-visible">
      ...
      <div className="flex flex-col flex-1 px-5 pt-20 pb-5">
        <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <Link href={href} className="block">
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold truncate transition-colors hover:text-yellow-200" title={suggestion.director}>{suggestion.director}</h3>
...
function ActorSuggestionCard({ suggestion }: { suggestion: ActorSuggestion }) {
  ...
  return (
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg h-[280px] flex flex-col overflow-visible">
      ...
      <div className="flex flex-col flex-1 px-5 pb-5 pt-14">
        <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold truncate transition-colors hover:text-yellow-200" title={suggestion.actor}>{suggestion.actor}</h3>
            <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-800 text-xs text-gray-200" title="You've seen">
              {suggestion.seen_count}
            </span>
          </div>
    ...
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg h-[280px] flex flex-col overflow-visible">
      ...
      <div className="flex flex-col flex-1 px-5 pb-5 pt-14">
        ...
        <div className="flex-1 min-w-0">
          <Link href={href} className="block">
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold truncate transition-colors hover:text-yellow-200" title={suggestion.genre}>{suggestion.genre}</h3>
              <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-800 text-xs text-gray-200" title="You've seen">
    ...
    <div className="relative bg-gray-900/60 border border-yellow-500/20 rounded-lg h-[280px] flex flex-col overflow-visible">
      ...
      <div className="flex flex-col flex-1 px-5 pb-5 pt-14">
        ...
        <div className="flex-1 min-w-0">
          <Link href={href} className="block">
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold truncate transition-colors hover:text-yellow-200" title={suggestion.decade}>{suggestion.decade}</h3>
              <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-800 text-xs text-gray-200" title="You've seen">
                {filteredCount}{totalSeen > 100 ? '∗' : ''}
              </span>
            </div>

        ...
        <>
          ...
          {almost.length > 0 && (
            <div className="bg-gray-900/60 border border-yellow-500/20 rounded-lg p-5 mt-6">
              ...
              <p className="text-sm text-gray-400 mb-4">Directors where you’re close — hit 10 seen films to unlock a Ready‑Made list.</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {almost.map((a) => (
                  <div key={a.director} className="flex items-center justify-between bg-gray-800/50 rounded-md p-3">
                    <div>
                      <div className="text-white font-medium">{a.director}</div>
                      <div className="text-xs text-gray-400">{a.seen_count} of 10 seen</div>
                    </div>
                    <div className="w-24">

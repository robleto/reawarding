...
export async function GET(request: Request) {
  try {
    ...
    const category = (searchParams.get('category') || 'best-picture') as 'best-picture' | 'best-animated' | 'best-comedy' | 'best-drama' | 'best-debut';
...
export async function POST(request: Request) {
  try {
    ...
    const category = (bodyCategory || 'best-picture') as 'best-picture' | 'best-animated' | 'best-comedy' | 'best-drama' | 'best-debut';

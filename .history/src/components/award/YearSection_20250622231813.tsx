	...
	return (
		<section className="w-full max-w-screen-xl px-6 py-0 mx-auto my-0 font-sans">
			<div className="relative flex flex-col gap-6 md:flex-row md:gap-8">
				...
				<div className="absolute left-[-1.5rem] top-6 flex flex-col items-center">
					<h2 className="rotate-[-90deg] font-unbounded text-xl text-[#1c3728] tracking-widest">
						{year}
					</h2>
					<div className="w-4 h-4 mt-2 rounded-full bg-[#d6d6d3] border-2 border-white" />

...
export default function YearSection({
	...
	return (
		<section className="w-full max-w-screen-xl px-6 pt-0 mt-0 font-sans pb-mx-auto">
			<div className="relative flex flex-col gap-6 md:flex-row md:gap-8">
				...
				{/* Content block */}
				<div className="flex flex-col md:flex-row w-full bg-white rounded-xl shadow-md border border-[#d6d6d3] p-6 mb-24 ">
					{/* Winner */}

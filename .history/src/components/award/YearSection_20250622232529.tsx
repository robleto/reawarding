	...
	return (
		<section className="w-full max-w-screen-xl px-6 py-0 mx-auto my-0 font-sans">
			<div className="relative flex flex-col gap-6 md:flex-row md:gap-8">
				...
				<h2 className="absolute top-[115px] left-0 text-3xl font-bold text-[#1c3728] mt-2 rotate-[-90deg] origin-left font-['Unbounded'] tracking-widest">
					{year}
				</h2>
				<div className="absolute top-0 bottom-0 flex flex-col items-center left-3">
					{/* <h2 className="text-3xl font-bold text-[#1c3728] mt-2">
						{year}
					</h2> */}
					<div className="w-5 h-5 mt-2 rounded-full bg-[#d6d6d3] border-2 border-[F4F4F4]]" />

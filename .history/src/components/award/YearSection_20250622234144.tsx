	...
	return (
		<section className="w-full max-w-screen-xl px-6 py-0 mx-auto my-0 font-sans">
			<div className="relative flex flex-col gap-6 md:flex-row md:gap-8">
				...
				<div className="absolute top-0 bottom-0 flex flex-col items-center display-none left-4">
					{/* <h2 className="text-3xl font-bold text-[#1c3728] mt-2">
						{year}
					</h2> */}
					<div className="w-5 h-5 mt-2 rounded-full bg-[#A0A0A0] border-2 border-[#F4F4F4] display-none" />
					<div className="w-[2px] flex-1 bg-[#bebebe] display-none" />
				</div>

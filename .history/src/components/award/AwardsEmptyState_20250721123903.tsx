		...
		<div className="min-h-[60vh] flex items-center justify-center">
			<div className="px-6 py-16 text-center">
				...
				<p className="mb-8 text-xl text-gray-600 dark:text-gray-300">
					Create custom Best Picture awards by year, with your own
					nominees and winners based on your movie ratings.
				</p>
				...
				<div className="p-8 mb-8 border shadow-xl bg-white/70 dark:bg-gray-900/70 backdrop-blur-lg border-gray-200/50 dark:border-gray-700/50 rounded-xl">
					...
					<div className="grid grid-cols-1 gap-6 text-sm md:grid-cols-3">
						...
						<div className="text-center">
							...
							<h4 className="mb-2 font-semibold text-gray-900 dark:text-white">
								2. Auto-Generated Years
							</h4>
							<p className="text-gray-600 dark:text-gray-300">
								We organize your top-rated movies by release
								year
							</p>
						</div>
						<div className="text-center">
							...
							<p className="text-gray-600 dark:text-gray-300">
								Adjust nominees and pick who you think should
								have won
							</p>
						</div>
					</div>
					...
					<div className="p-4 mt-8 border-2 border-gray-300 border-dashed rounded-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm dark:border-gray-600">
						<div className="text-center text-gray-500 dark:text-gray-400">
							...
							<p className="text-sm">
								...
								Rate 10+ movies from 2023 → Get a &quot;Best
								Picture 2023&quot; category with your top picks
								as nominees, then choose who you believe should
								have won
							</p>
						</div>
					</div>

...
export default function YearSection({
	...
	return (
		<section className="w-full max-w-screen-xl px-6 pt-0 font-sans pb-mx-auto">
			<div className="relative flex flex-col gap-6 md:flex-row md:gap-8">
				...
				<div className="absolute top-0 bottom-0 left-0 flex flex-col items-center">
					<h2 className="text-3xl font-bold text-[#1c3728] mt-2 mb-[-30px]">
						{year}
					</h2>
				...
				{/* Content block */}
				<div className="flex flex-col md:flex-row w-full bg-white rounded-xl shadow-md border border-[#d6d6d3] p-6 gap-12">
					{/* Winner */}

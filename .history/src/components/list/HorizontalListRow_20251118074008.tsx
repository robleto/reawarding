  ...
  return (
    <div className="mb-10">
      ...
      <div className="relative overflow-visible">
        <div className="flex gap-5 overflow-x-auto pb-4 pt-4 pr-3 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
          {lists.map((list) => (
            <div key={list.id} className="min-w-[280px] max-w-[280px] flex-shrink-0 overflow-visible">
          ...
          {!readOnly && onAdd && (
            <div
              className="min-w-[280px] max-w-[280px] h-[320px] flex-shrink-0 flex flex-col items-center justify-center border-2 border-dashed border-gray-500/40 light-glass dark:dark-glass rounded-xl shadow-md cursor-pointer hover:shadow-lg transition-all p-6 group"
              onClick={onAdd}
              tabIndex={0}
              role="button"
          ...
          {!readOnly && (
            <Link
              ...
              className="min-w-[280px] max-w-[280px] h-[320px] flex-shrink-0 flex flex-col items-center justify-center border-2 border-dashed border-yellow-500/40 light-glass dark:dark-glass rounded-xl shadow-md hover:shadow-lg transition-all p-6 group"

  ...
  return (
    <div className="mb-10">
      ...
      <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
        ...
        {!readOnly && onAdd && (
          <div
            className="min-w-[260px] max-w-[260px] h-[320px] flex-shrink-0 flex flex-col items-center justify-center border-2 border-dashed border-gray-500/40 light-glass dark:dark-glass rounded-xl shadow-md cursor-pointer hover:shadow-lg transition-all p-6 group"
            onClick={onAdd}
            tabIndex={0}
            role="button"
        ...
        {!readOnly && (
          <Link
            ...
            className="min-w-[260px] max-w-[260px] h-[320px] flex-shrink-0 flex flex-col items-center justify-center border-2 border-dashed border-yellow-500/40 light-glass dark:dark-glass rounded-xl shadow-md hover:shadow-lg transition-all p-6 group"

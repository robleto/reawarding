...
-- (Prefer metadata username/login; fall back to email local-part; avoid
-- collisions) rather than the raw email address the current trigger
-- (20251202101500_align_profiles_schema.sql) falls back to — an email
-- address is not a valid public-facing username/URL slug.
